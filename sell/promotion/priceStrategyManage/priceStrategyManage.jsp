...
<html>
  <head>
	  ...
	  <link href="page/sell/promotion/priceStrategyManage/priceStrategyManage.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/sell/promotion/priceStrategyManage/priceStrategyManage.js"></script>
	  <style type="text/css">
	  ...
	  <script type="text/javascript">var BASEPATH = '<%=basePath%>';var tid = '<%=request.getAttribute("tid")%>'</script>
  </head>
  <body>
  </body>
</html>
