...
<html>
  <head>
	  ...
	  <link href="page/sell/promotion/priceStrategy/priceStrategy.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/sell/promotion/priceStrategy/priceStrategy.js"></script>
	  <style type="text/css">
