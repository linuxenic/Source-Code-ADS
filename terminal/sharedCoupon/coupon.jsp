...
<html>
  <head>
	  ...
	  <link href="page/terminal/sharedCoupon/coupon.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/terminal/sharedCoupon/coupon.js"></script>
	  <style type="text/css">
