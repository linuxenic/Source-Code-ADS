...
<html>
  <head>
	  ...
	  <link href="page/terminal/warn/warnHistory/warnHistory.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/terminal/warn/warnHistory/warnHistory.js"></script>
