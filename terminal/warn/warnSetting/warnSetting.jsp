...
<html>
  <head>
	  ...
	  <link href="page/terminal/warn/warnSetting/warnSetting.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/terminal/warn/warnSetting/warnSetting.js"></script>
