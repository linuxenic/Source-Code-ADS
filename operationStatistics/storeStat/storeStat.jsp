...
<html>
  <head>
	  ...
	  <link href="page/operationStatistics/storeStat/storeStat.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript">var stid  = '<%=request.getAttribute("tid")%>';</script>
	  <script type="text/javascript" src="page/operationStatistics/storeStat/storeStat.js"></script>
	  <style type="text/css">
