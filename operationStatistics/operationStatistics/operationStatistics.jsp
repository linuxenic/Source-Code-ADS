...
<html>
  <head>
	  ...
	  <link href="page/operationStatistics/operationStatistics/operationStatistics.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/operationStatistics/operationStatistics/operationStatistics.js"></script>
	  <style type="text/css">
