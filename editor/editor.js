...
Ext.define('Ext.ux.form.TinyMCETextArea', {
    ...
    alias: ['widget.tinymce_textarea', 'widget.tinymce'],
    ...
    syncEditorHeight: function (height) {
        ...
        var bottombar = parent.down(".mce-statusbar");
        var bottombar_body = parent.down(".mce-edit-area");
        if(bottombar&&bottombar_body) {
//        	bottombar.setStyle({display : 'none'});
        	bottombar_body.setStyle({height:'100%'});
        }
        ...
        me.tinyMCEConfig.setup = function (ed) {
            ...
            ed.on('init', function(e) {
                ...
                if(height) {
                  ...
                  setTimeout(function () { me.syncEditorHeight(height); }, 500);
                }
            });
