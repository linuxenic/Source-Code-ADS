...
<html>
  <head>
	  ...
	  <link href="page/livetoy/roomManage/roomManage.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/livetoy/roomManage/roomManage.js"></script>
