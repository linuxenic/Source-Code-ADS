...
<html>
  <head>
	  ...
	  <link href="page/statistics/statistics/statistics.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/statistics/statistics/statistics.js"></script>
