...
<html>
  <head>
	  ...
	  <link href="page/statistics/terminalOutline/terminalOutline.css" rel="stylesheet" type="text/css" />
...
<!-- 	  <script type="text/javascript" src="js/editor/tinymce.min.js"></script>
	  ...
	  <script type="text/javascript" src="page/statistics/terminalOutline/terminalOutline.js"></script>
  ...
  <body>
	  <div id="viewport_Container" style="width:100%;"></div> 
