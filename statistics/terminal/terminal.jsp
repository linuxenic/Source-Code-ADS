...
<html>
  <head>
	  ...
	  <link href="page/statistics/terminal/terminal.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript">var btime  = '<%=request.getAttribute("btime")%>';</script>
	  <script type="text/javascript">var etime  = '<%=request.getAttribute("etime")%>';</script>
	  <script type="text/javascript">var tid  = '<%=request.getAttribute("tid")%>';</script>
	  <script type="text/javascript">var showType  = '<%=request.getAttribute("showType")%>';</script>
	  <script type="text/javascript" src="page/statistics/terminal/terminal.js"></script>
	  <style type="text/css">
