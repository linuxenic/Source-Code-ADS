...
<html>
  <head>
	  ...
	  <link href="page/elevator/sourceManage/sourceManage.css" rel="stylesheet" type="text/css" />
	  <link href="js/ext/examples/shared/example.css"  rel="stylesheet" type="text/css" />
	  
	  <script type="text/javascript" src="page/weixin/jquery.js"></script>
	  ...
	  <script type="text/javascript" src="page/elevator/sourceManage/sourceManage.js"></script>
