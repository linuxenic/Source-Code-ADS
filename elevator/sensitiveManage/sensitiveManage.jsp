...
<html>
  <head>
	  ...
	  <link href="page/elevator/sensitiveManage/sensitiveManage.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/elevator/sensitiveManage/sensitiveManage.js"></script>
