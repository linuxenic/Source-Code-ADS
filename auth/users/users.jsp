...
<html>
  <head>
	  ...
	  <script type="text/javascript">var localVersion= '<%=localVersion%>';</script>
	  <script type="text/javascript" src="js/business.js"></script>
	  <script type="text/javascript" src="page/auth/users/users.js"></script>
	  <script type="text/javascript" src="page/auth/users/users_appendA.js"></script>
	  <script type="text/javascript" src="page/auth/users/users_shared.js"></script>
	  <style type="text/css">
