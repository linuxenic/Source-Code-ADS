...
<%@page import="com.common.BusinessUtil"%>
<%
	String path = request.getContextPath();
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
	String version_xm = CacheUtil.getConfg().getConfigValue("local");
	...
	String azldcenter = CacheUtil.getConfg().getConfigValue("azldcenter");
	...
	// 是否有容量权限 add by 2018-11
	boolean hascapacity = BusinessUtil.instance().hasCapactiyFN();
%>
<!DOCTYPE html>
<html>
  <head>
	  ...
	  <link href="page/auth/users/users.css" rel="stylesheet" type="text/css" />
	  <link href="page/auth/customer/customer.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript">
  		...
  		var local = '<%=local%>';
   		var version_xm="<%=version_xm%>";
   		version_xm=version_xm=="xm";
   		var azldcenter = '<%=azldcenter%>';
   		var isInter = '<%=flagInter%>';
   		var cap = eval('<%=hascapacity%>');
	  </script>
	  <script type="text/javascript" src="page/auth/users/users_appendA.js"></script>
	  <script type="text/javascript" src="page/auth/customer/customer.js"></script>
	  <script type="text/javascript" src="page/auth/customer/addUser.js"></script>
