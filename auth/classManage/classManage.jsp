...
<html>
  <head>
	  ...
	  <link href="page/auth/classManage/classManage.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/auth/classManage/classManage.js"></script>
	  <style type="text/css">
