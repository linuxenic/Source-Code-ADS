...
<!-- 	  <script type="text/javascript" src="http://api.map.baidu.com/api?v=1.4"></script>百度地图的js文件  -->
	  <script type="text/javascript">
	   ...
	   <script type="text/javascript" src="page/equipment/equip/equip.js"></script>
	  <style type="text/css">
	  ...
	  <link href="page/equipment/equip/equip.css" rel="stylesheet" type="text/css" />
