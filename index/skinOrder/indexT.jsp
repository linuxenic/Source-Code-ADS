...
<%
	...
	if(currentLanguage.equals("EN")){
		indexPic = "title_oen.png";
	}else{
		indexPic = "title_o.png";
	}
	String welcomelau = "";
	if(!"".equals(system_name) && null!=system_name){
		...
		}else if("KN".equals(currentLanguage)){
			welcomelau =  languageConfig.get("ordername").toString();
		}else{
...
<html>
  <head>
	  ...
	  <link href="page/index/skinOrder/indexT.css" rel="stylesheet" type="text/css" />
	  ...
	  <script type="text/javascript" src="page/index/skinOrder/indexT.js"></script>
  ...
  <BODY class="indexContentDiv">
        <div id="contentDiv" style="height:100%;">
				...
				<div class="salesInfo" id="salesInfo" >
					<div class="salesInfo_div" id="salesInfo_div" >		
						<ul class="salesInfo_ul" id="salesInfo_ul" >
							<li class="month_sales" id="month_sales" ></li>
							<li class="day_sales" id="day_sales" ></li>
							<li class="terminal_ranking1" id="terminal_ranking1" ></li>
							<li class="terminal_ranking2" id="terminal_ranking2" ></li>
							<li class="good_ranking1" id="good_ranking1" ></li>
							<li class="good_ranking2" id="good_ranking2" ></li>
							<li class="click_event" id="click_event" ></li>
						</ul>
					</div>					
				</div>
		...
		<div id="bigtitle" class="bigtitle"><%-- <img class='imgcss' src='images/systemVersion/order/<%=indexPic%>'> --%><%=welcomelau%></div>
        <!-- appIframe area -->
